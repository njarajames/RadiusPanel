...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="stat_cli.php">Statistique Clients</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form class="form-inline" id="radius-form">
                            <div class="col-auto">
                               
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">Utilisateur</div>
                                    </div>
                                    <select class="custom-select" id="username" required onchange="drawChart();">
                                        <option selected value="">Selectionner un utilisateur.</option>
                                        <?php
                                         require "config.php";    
    ...
    <script src="graph/graph_user_rad.js"></script>
