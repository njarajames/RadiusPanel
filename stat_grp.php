            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="stat_grp.php">Statistique Groupes</a>
                    </div>
                </div>
            </li>
                    ...
                    <form class="form-inline">
                            ...
                            <div class="col-auto">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="date" class="form-control" id="date_deb" placeholder="Username">
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="date" class="form-control" id="date_fin" placeholder="Username">
                                </div>
                            </div>
